...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <h4 class="page-header">Acreditar participantes</h4>
        {!! Form::open (['route' => 'acreditar','method' => 'post', 'class'=>'form_noEnter'])!!}
        <div class="col-xs-12 col-md-10 col-md-offset-1">
            <table class="table table-striped table-bordered table-condensed table-hover table-responsive"
                ...
                <tr>
                    ...
                    <th>Provincia</th>
                    <th>Deporte</th>
                    <th class="non_searchable">
                        {!! Form::checkbox('acred_all',null,false,['id'=>'acred_all','data-toggle'=>'tooltip', 'data-placement'=>'top','title'=>'Seleccionar todos']) !!}
                        <a href="{{route('acreditar')}}">
                            {!! Form::button(' <span class="glyphicon glyphicon-check" aria-hidden="true"></span>',['class'=>'btn-xs btn-primary', 'type'=>'submit','id'=>'imprimir','data-toggle'=>'tooltip', 'data-placement'=>'top','title'=>'Acreditar seleccionados']) !!}
                        </a>
                    </th>
                </tr>
                </tfoot>
...
//                    var table = $('#atletas_table').DataTable({
    ...
    $(document).on('change', '#acred_all', function (event) {
