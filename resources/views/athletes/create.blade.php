                    ...
                    <div class="panel-body">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                {!! Form::select('event',['IX JUEGOS DEPORTIVOS NACIONALES PREJUVENILES GUAYAS 2017'=>'IX JUEGOS DEPORTIVOS NACIONALES PREJUVENILES GUAYAS 2017'],null,['class'=>'form-control','placeholder'=>'Evento ...','id'=>'event']) !!}
                                {{--<input type="select" class="form-control" id="funcion"  name="funcion" placeholder="provincia" style="text-transform:uppercase">--}}
                            </div>
                            <div class="form-group col-md-6">
