        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                    ...
                    &nbsp;
                    <li><a href="{{route('athletes.index')}}">Atletas <span
                                    class="sr-only">(current)</span></a></li>
                    <li><a href="{{route('athletes.create')}}">Crear Atleta <span class="sr-only">(current)</span></a></li>
                    <li><a href="{{route('print_athletes')}}">Credenciales <span class="sr-only">(current)</span></a></li>
                </ul>
